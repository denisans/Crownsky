...
<section class="breadcrumb-option">
    <div class="container">
        ...
        <br>
        <center>
            <h3 class="font-weight-bold"><i class="fa fa-search"></i> Search Rooms</h3>
        </center>
        <br>
        <br>
            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="checkout__input">
                        ...
                        <input type="text" class="datepicker" name="dari" id="tgl_dari" placeholder="Enter date.." required="required" value="<?php if(isset($_GET['dari'])){ echo date('d-m-Y', strtotime($_GET['dari'])); } ?>">
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="checkout__input">
                        <p>Check-Out Date<span>*</span></p>
                        <input type="text" class="datepicker" name="sampai" id="tgl_sampai" placeholder="Enter date.." required="required" value="<?php if(isset($_GET['sampai'])){ echo date('d-m-Y', strtotime($_GET['sampai'])); } ?>">
                    </div>
                </div>
                <div class="col-lg-1">
                    <div class="checkout__input">
                ...
                <div class="col-lg-2">
                    <br>
                    <center><button class="site-btn mt-2">Serach Rooms</button></center>
                </div>
        ...
        if(isset($_GET['dari'])){
            ...
            if($dari == $sampai){
                ...
                echo "<br><br><center>";
                echo "<h4><b>SEARCH RESULTS :</b> Available Rooms</h4> <br><br>";
                echo "</center>";
                    ...
                    if($k['kamar_jumlah'] > $c){
                        ...
                        <div class="row justify-content-center">
                            ...
                            <div class="col-lg-6">
                                ...
                                <br>
                                Remaining: <b><?php echo $sisa; ?> Room</b> 
                                <br>
                                <a class="site-btn py-2 px-2 mt-3" target="_blank" style="font-size: 8pt" href="kamar_detail.php?id=<?php echo $k['kamar_id']; ?>">VIEW ROOM</a>
                ...
                if($jumlah_tersedia == "0"){
                    echo "<div class='alert alert-danger text-center'><b>No available rooms.</b> Please search for different dates or rooms.</div>";
                }
            }
        }
        ?>
