	...
	<div class="container">
		<div class="row">
			...
			<div id="main" class="col-md-9">
				...
				<h4><b>INVOICE</b></h4>
				<br>
				<small class="text-muted">Room booking details</small>
				<br>
				<br>
				<div class="row">
					...
					while($i = mysqli_fetch_array($invoice)){
						...
						<div class="col-lg-12">
							...
							<a href="customer_pesanan.php" class="btn btn-warning btn-sm"><i class="fa fa-arrow-left"></i> BACK</a>
							<a href="customer_invoice_cetak.php?id=<?php echo $_GET['id'] ?>" target="_blank" class="btn btn-primary btn-sm"><i class="fa fa-print"></i> PRINT</a>
