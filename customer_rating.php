	...
	<div class="container">
		<div class="row">
			...
			<div id="main" class="col-md-9">
				...
				<h4><b>ROOM RATING</b></h4>
				<br>
				<small class="text-muted">fil rating and review the room</small>
						...
						<div class="col-lg-12">
							...
							if(isset($_GET['alert'])){
								if($_GET['alert'] == "sukses"){
									...
									<div class="alert alert-success"> YOUR RATING AND REVIEW HAS BEEN SAVED</div>
											...
											while($d=mysqli_fetch_array($transaksi)){
												...
												<tr>
													...
													<td>
														...
														<br>
														<small><i>Click on the desired star rating</i></small>
													</td>
													<td>
