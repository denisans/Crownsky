    ...
    <div class="container">
        <div class="checkout__form">
            ...
            if (isset($_GET['alert'])) {
                $alert = $_GET['alert'];
                if ($alert == "tersedia") {
                    echo "<div class='alert alert-success text-center'><b>Room available.</b> Please click \"CHECKOUT\"  to proceed with booking</div>";
                } elseif ($alert == "tidak-tersedia") {
                    echo "<div class='alert alert-danger text-center'><b>Room is not available.</b> Please search for other dates or rooms</div>";
                }
            }
            ?>
                        ...
                        <form action="booking_act.php" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="checkout__input">
                                    ...
                                    <input type="number" name="quantity" required="required" min="1" value="<?php if(isset($_SESSION['booking_jumlah_kamar'])){ echo $_SESSION['booking_jumlah_kamar']; } ?>">
                                </div>
                            </div>
                                <div class="col-lg-2">
                                    <div class="checkout__input">
                            ...
                            <center><button class="site-btn">CHECK ROOM AVAILABITIY</button></center>
                        </form>
